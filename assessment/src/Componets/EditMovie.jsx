...
import { edit } from '../Store/Reducers/MovieData';
const genreList = [
    "Action",
    "Comedy",
    "Drama",
...
const EditMovie = ({movie}) =>
{
    ...
    console.log( "Movidata", MovieData );
  ...
  return (
    <div className='z-50 inset-0 flex flex-col items-center justify-center bg-black bg-opacity-50 backdrop-filter backdrop-blur-sm pt-[1rem] lg:pt-[15rem] fixed overflow-y-scroll w-full h-full'>
      <div className='border-2 border-gray-300 rounded-[12px] flex flex-col py-3 px-7 w-fit min-w-[350px] lg:w-[500px]  h-fit my-8  bg-white relative'>
        <div className='grid grid-cols-3 gap-4 pb-4'>
          <div className='flex flex-row col-span-2 ...'>
            <h4 className='font-bold'> Edit The Movie Details</h4>
          </div>
